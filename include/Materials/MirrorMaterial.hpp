 ...
 public:
  MirrorMaterial(
    ...
    const Spectrum& ambient, const Spectrum& diffuse,
                 const Spectrum& specular, FP_PRECISION phong_exponent, FP_PRECISION roughness,
                 const Spectrum& mirror, FP_PRECISION refraction_index, FP_PRECISION absorption_index)
