...
BaseCamera::BaseCamera(
    ...
    const unsigned int num_samples, std::vector<std::shared_ptr<BaseToneMapping>> tone_mappings, int max_recursion_depth, int min_recursion_depth, bool left_handed,
    const bool path_tracing_enabled,
    const bool importance_sampling_enabled,
    const bool nee_enabled,
    ...
    : position_(position),
      ...
      importance_sampling_enabled_(importance_sampling_enabled),
      nee_enabled_(nee_enabled),
